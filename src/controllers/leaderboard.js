...
module.exports = {
////// GET ALL Leaderboard ///////////////////////////////////////
CgetAllLeaderboard: (req, res) => {
    LeaderboardModel.MgetAllLeaderboard()
        .then((resultData) => {
...
////// GET ALL Leaderboard ///////////////////////////////////////
CgetAllscore: (req, res) => {
    LeaderboardModel.MgetAllscore()
        .then((resultData) => {
            miscHelpers.response(res, resultData)
        })
        .catch((error) => {
...
/////// GET 1 Leaderboard /////////////////////////////////////////////
    CgetByidLeaderboard: (req, res) => {
        ...
        LeaderboardModel.MgetByidLeaderboard(iduser)
        .then((resultData) => {
...
///////  POST Leaderboard //////////////////////////////////////////////
    CpostLeaderboard: (req, res) => {
        ...
        LeaderboardModel.MpostLeaderboard(data)
        .then(()=> {
...
CeditPlayer: (req, res) => {
    ...
    LeaderboardModel.MeditPlayer(data,idnya)
            .then((resultRegister) => {
...
//////// LOGIN POST /////////////////////////////////////////
    login: (req, res) => {
        ...
        LeaderboardModel.MloginPlayer(username)
            .then((result) => {
                ...
                if (usePassword === dataUser.password) {
                    ...
                    LeaderboardModel.updateToken(username, token)
                        .then((resultToken) => {
...
/////////////////////////////////////////////////
    logout: (req, res) => {
        ...
        LeaderboardModel.MlogoutPlayer(iduser)
            .then(() => {
